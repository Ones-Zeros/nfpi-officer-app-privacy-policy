...
This privacy policy applies to the NFPI Officer app (hereby referred to as "Application") for mobile devices that was created by Ones & Zeros (pvt) Ltd (hereby referred to as "Service Provider") as a Free service. This service is intended for use "AS IS".
